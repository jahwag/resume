...
\ensurespace{12}
\begin{rSection}{Consulting Experience}

\ensurespace{4}
\begin{rSubsection}{Agency for digital government}{September 2024 -- Present}{Software Developer - State electronic identification}{Stockholm}
\bItem Brought on-board to develop the Swedish government's electronic identification within the scope of the EU electronic identification and trust services (eIDAS) regulation.
\end{rSubsection}

\ensurespace{13}
\begin{rSubsection}{KINDRED PEOPLE AB}{August 2021 -- January 2024}{Software Engineer Java - Pay and Withdraw Experience}{Stockholm}
...
\ensurespace{12}
\begin{rSubsection}{ERICSSON AB}{March 2019 -- January 2020}{Software Developer - Guided Sales Digital Platform}{Stockholm}
...
\ensurespace{12}
\begin{rSubsection}{INERA AB}{May 2018 -- February 2019}{Data Migration Lead - Hjälpmedelstjänsten 2.0}{Stockholm}
...
\ensurespace{12}
\begin{rSubsection}{SAAB AB}{February 2017 -- April 2018}{Software Developer - 9LV CMS}{Järfälla}
...
\ensurespace{10}
\begin{rSubsection}{PIERCE AB}{August 2016 -- December 2016}{Software Developer - E-commerce platform}{Stockholm}
...
\ensurespace{6}
\begin{rSubsection}{GOVERNMENT AGENCY}{September 2013 -- June 2014}{Forward Deployed Engineer - Client solutions}{Stockholm} % GPT: Translate GOVERNMENT AGENCY to MYNDIGHET
...
\bItem Engaged in various client projects, providing expertise in Java development and system integration.
\end{rSubsection}
...
\bItem Participated in multiple short-term projects, gaining diverse industry experience.
\end{rSubsection}
\end{rSection}
